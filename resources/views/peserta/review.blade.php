<x-peserta-layout>
    ...
    <div class="max-w-3xl mx-auto">
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
                <a href="{{ route('ujian.hasil', $attempt->id) }}" class="inline-flex items-center gap-1 text-sm text-indigo-600 hover:underline">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
                    Hasil Ujian
                </a>
                <h1 class="text-xl sm:text-2xl font-bold text-gray-900 mt-2">Review Jawaban</h1>
                <p class="text-gray-500 text-sm">{{ $attempt->session->nama_sesi }}</p>
            </div>
