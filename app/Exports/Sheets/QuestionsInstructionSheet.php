...
class QuestionsInstructionSheet implements FromArray, WithTitle, WithStyles, WithColumnWidths
{
  ...
  public function array(): array
  {
    return [
      ...
      ['mata_pelajaran', 'Nama mata pelajaran (opsional). Digunakan untuk mengelompokkan kategori. Jika kategori belum ada, mata_pelajaran akan digunakan saat membuat kategori baru.', 'Matematika'],
      ...
      ['PGJ', 'Pilihan Ganda Kompleks (multi-jawaban)', 'Huruf dipisah koma. Contoh: A,C'],
